...
export default {
    data() {
        return {//组件界面定义变量
            ...
            //推荐医生的数组
            doctorList:[
                {name:'刘长胜',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'孙鹿',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'吕文达',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'李若辰',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'张石凡',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'赵桂凤',job:'副主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'李文',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796.jpg'},
                {name:'吴晓梦',job:'主任医师',img:'https://img1.baidu.com/it/u=2230649002,3216622932&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=796'},
            ]
        }
    },
    methods: {
